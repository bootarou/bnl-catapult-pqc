...
namespace catapult { namespace harvesting {
	...
	public:
		...
		BlockGeneratorAccountDescriptor(crypto::KeyPair&& signingKeyPair, crypto::VrfKeyPair&& vrfKeyPair);
	...
	public:
		...
		const crypto::VrfKeyPair& vrfKeyPair() const;
	...
	private:
		...
		crypto::VrfKeyPair m_vrfKeyPair;
	};
}}
