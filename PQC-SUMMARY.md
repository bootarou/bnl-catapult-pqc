...
### 3-3. JavaScript SDK（`sdk/javascript` → 公開: `pqc-catapult-sdk-v2`）
...
- npm git インストール対応: 壊れたサブモジュール（`catbuffer-generators` / `travis`、参照先消滅）を削除、
...
| [pqc-catapult-sdk-v2](https://github.com/bootarou/pqc-catapult-sdk-v2) | `feat-pqc` | TypeScript SDK（symbol-sdk 2.x 系 PQC 版。npm git 依存として利用可） |
